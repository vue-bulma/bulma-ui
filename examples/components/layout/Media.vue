    ...
    <example-section-item title="Basic">
      <demo>
        <vb-media-object>
          ...
          <vb-delete slot="right"></vb-delete>
        ...
        <vb-media-object>
          ...
          <vb-form-item>
            <vb-textarea placeholder="Add a comment..."></vb-textarea>
          </vb-form-item>
          ...
          <vb-level>
            ...
            <vb-level-item slot="right">
              <vb-checkbox>Press enter to submit</vb-checkbox>
            </vb-level-item>
          </vb-level>
        </vb-media-object>
      ...
      <demo>
        <vb-media-object>
          ...
          <vb-media-object>
            ...
            <vb-media-object>Vivamus quis semper metus, non tincidunt dolor. Vivamus in mi eu lorem cursus ullamcorper sit amet nec massa.</vb-media-object>
            <vb-media-object>Morbi vitae diam et purus tincidunt porttitor vel vitae augue. Praesent malesuada metus sed pharetra euismod. Cras tellus odio, tincidunt iaculis diam non, porta aliquet tortor.</vb-media-object>
          </vb-media-object>
