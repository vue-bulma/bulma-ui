<template>
  <demo :code="columnsThree">
    <vb-tile>
      <vb-tile>
        <vb-box>
          <vb-title>Hello World</vb-title>
          <vb-subtitle>What is up?</vb-subtitle>
        </vb-box>
      </vb-tile>
      <vb-tile>
        <vb-box>
          <vb-title>Foo</vb-title>
          <vb-subtitle>Bar</vb-subtitle>
        </vb-box>
      </vb-tile>
      <vb-tile>
        <vb-box>
      ...
      <vb-tile vertical size="8">
        <vb-tile>
          <vb-tile vertical>
            <vb-tile>
              <vb-box>
                ...
                <vb-subtitle>Top box</vb-subtitle>
              </vb-box>
            </vb-tile>
            <vb-tile>
              <vb-box>
                <vb-title>Vertical tiles</vb-title>
                <vb-subtitle>Bottom box</vb-subtitle>
              </vb-box>
            </vb-tile>
          </vb-tile>
          ...
          <vb-tile>
            <vb-box>
              ...
              <vb-subtitle>With an image</vb-subtitle>
        ...
        <vb-tile>
          <vb-box>
            ...
            <vb-subtitle>Aligned with the right tile</vb-subtitle>
            <vb-content>
              <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin ornare magna eros, eu pellentesque tortor vestibulum ut. Maecenas non massa sem. Etiam finibus odio quis feugiat facilisis.</p>
            </vb-content>
          </vb-box>
      ...
      <vb-tile>
        <vb-box>
          <vb-content>
            ...
            <vb-subtitle>With even more content</vb-subtitle>
            <vb-content>
...
export default {
  ...
  data() {
    return {
      columnsThree: code.columnsThree
    }
  }
}
</script>
